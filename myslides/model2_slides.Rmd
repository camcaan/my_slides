...
<img src="img/model2.png"  width="45%">

* **Note: No data on patients going out of institution (Institutionalisation to out) or entering institution once they are discharged from hospital (Out to Institutionalisation). Therefore, Institutionalisation may include post-institutionalisation stay and similarly, "Out" could include pre-institutionalisation stay. So, here institutionalisation means everything that happens once a patient is discharged to an institution from hospital and Out may include everything that happens to a patient once discharged from hospital.**
???
