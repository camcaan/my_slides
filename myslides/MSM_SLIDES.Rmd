...
***Using Multi-state modelling approach because of its 3 attractive features***
   ...
   **The standard survival models are ill-equipeped t juggle al of these balls at once.**
...
* **A coomon rule of thumb is that if the GVIF is greater than 5-10 for any variable then multicollinearity may exist**
